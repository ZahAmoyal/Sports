...
public class SportsArticles {
    ...
    By firstArticle = By.cssSelector(".word-main-article.main-article.banner-holder.mainarticle-world");

    By tohen1 = By.cssSelector("[id='find-article-content'] p");
    ...
    public static void setup() {
        ...
        @Test
        public void sportFiveNews{
            sports(urlIsraeliSportFive);
            sports(urlOlamiSportFive);
        }


        @Test
        public void sportOneNews{
            sports("https://www.one.co.il/Soccer/News/1");
            sports("https://www.one.co.il/Soccer/News/3");
        }
